...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ActionAddButton.setGeometry(QRect(619, 410, 91, 23))
        ...
        self.ActionUpdateRowButton = QPushButton(self.HelpTeachPage)
        self.ActionUpdateRowButton.setObjectName(u"ActionUpdateRowButton")
        self.ActionUpdateRowButton.setGeometry(QRect(729, 410, 91, 23))
        ...
        self.ActionUpdateColButton = QPushButton(self.HelpTeachPage)
        self.ActionUpdateColButton.setObjectName(u"ActionUpdateColButton")
        self.ActionUpdateColButton.setGeometry(QRect(828, 410, 91, 23))
        self.RecordActivateButton = QRadioButton(self.HelpTeachPage)
        self.RecordActivateButton.setObjectName(u"RecordActivateButton")
        self.RecordActivateButton.setGeometry(QRect(245, 4, 91, 31))
        self.RecordDeActivateButton = QRadioButton(self.HelpTeachPage)
        self.RecordDeActivateButton.setObjectName(u"RecordDeActivateButton")
        self.RecordDeActivateButton.setGeometry(QRect(357, 8, 91, 21))
        ...
        self.ArmToolComboBox.setGeometry(QRect(119, 36, 111, 21))
        ...
        self.RobotArmPositionControlGroup.setGeometry(QRect(1272, 90, 251, 221))
        self.ZAxisAddButton = QPushButton(self.RobotArmPositionControlGroup)
        self.ZAxisAddButton.setObjectName(u"ZAxisAddButton")
        self.ZAxisAddButton.setGeometry(QRect(180, 114, 51, 31))
        self.XAxisEdit = QLineEdit(self.RobotArmPositionControlGroup)
        self.XAxisEdit.setObjectName(u"XAxisEdit")
        self.XAxisEdit.setGeometry(QRect(100, 34, 71, 31))
        self.XAxisEdit.setReadOnly(False)
        self.YAxisAddButton = QPushButton(self.RobotArmPositionControlGroup)
        self.YAxisAddButton.setObjectName(u"YAxisAddButton")
        self.YAxisAddButton.setGeometry(QRect(180, 74, 51, 31))
        self.Zlable = QLabel(self.RobotArmPositionControlGroup)
        self.Zlable.setObjectName(u"Zlable")
        self.Zlable.setGeometry(QRect(14, 124, 20, 20))
        self.YLable = QLabel(self.RobotArmPositionControlGroup)
        self.YLable.setObjectName(u"YLable")
        self.YLable.setGeometry(QRect(13, 84, 21, 20))
        self.XAxisSubButton = QPushButton(self.RobotArmPositionControlGroup)
        self.XAxisSubButton.setObjectName(u"XAxisSubButton")
        self.XAxisSubButton.setGeometry(QRect(40, 34, 51, 31))
        self.YAxisEdit = QLineEdit(self.RobotArmPositionControlGroup)
        self.YAxisEdit.setObjectName(u"YAxisEdit")
        self.YAxisEdit.setGeometry(QRect(100, 74, 71, 31))
        self.YAxisEdit.setReadOnly(False)
        self.YAxisSubButton = QPushButton(self.RobotArmPositionControlGroup)
        self.YAxisSubButton.setObjectName(u"YAxisSubButton")
        self.YAxisSubButton.setGeometry(QRect(40, 74, 51, 31))
        self.ZAxisEdit = QLineEdit(self.RobotArmPositionControlGroup)
        self.ZAxisEdit.setObjectName(u"ZAxisEdit")
        self.ZAxisEdit.setGeometry(QRect(100, 114, 71, 31))
        self.ZAxisEdit.setReadOnly(False)
        self.XLable = QLabel(self.RobotArmPositionControlGroup)
        self.XLable.setObjectName(u"XLable")
        self.XLable.setGeometry(QRect(13, 44, 21, 20))
        self.ZAxisSubButton = QPushButton(self.RobotArmPositionControlGroup)
        self.ZAxisSubButton.setObjectName(u"ZAxisSubButton")
        self.ZAxisSubButton.setGeometry(QRect(40, 114, 51, 31))
        self.XAxisAddButton = QPushButton(self.RobotArmPositionControlGroup)
        self.XAxisAddButton.setObjectName(u"XAxisAddButton")
        self.XAxisAddButton.setGeometry(QRect(180, 34, 51, 31))
        self.CoordinateStepLable = QLabel(self.RobotArmPositionControlGroup)
        self.CoordinateStepLable.setObjectName(u"CoordinateStepLable")
        self.CoordinateStepLable.setGeometry(QRect(8, 160, 31, 20))
        self.CoordinateStepEdit = QLineEdit(self.RobotArmPositionControlGroup)
        self.CoordinateStepEdit.setObjectName(u"CoordinateStepEdit")
        self.CoordinateStepEdit.setGeometry(QRect(100, 154, 71, 31))
        self.CoordinateStepEdit.setReadOnly(False)
        self.CoordinateAddButton = QPushButton(self.RobotArmPositionControlGroup)
        self.CoordinateAddButton.setObjectName(u"CoordinateAddButton")
        self.CoordinateAddButton.setGeometry(QRect(180, 154, 51, 31))
        self.CoordinateStepSubButton = QPushButton(self.RobotArmPositionControlGroup)
        self.CoordinateStepSubButton.setObjectName(u"CoordinateStepSubButton")
        self.CoordinateStepSubButton.setGeometry(QRect(40, 154, 51, 31))
        self.CoordinateStepSubButton.raise_()
        self.ZAxisAddButton.raise_()
        self.XAxisEdit.raise_()
        self.YAxisAddButton.raise_()
        self.Zlable.raise_()
        self.YLable.raise_()
        self.XAxisSubButton.raise_()
        self.YAxisEdit.raise_()
        self.YAxisSubButton.raise_()
        self.ZAxisEdit.raise_()
        self.XLable.raise_()
        self.ZAxisSubButton.raise_()
        self.XAxisAddButton.raise_()
        self.CoordinateStepLable.raise_()
        self.CoordinateStepEdit.raise_()
        self.CoordinateAddButton.raise_()
        self.RobotArmControlGroup = QGroupBox(Form)
        self.RobotArmControlGroup.setObjectName(u"RobotArmControlGroup")
        self.RobotArmControlGroup.setGeometry(QRect(1000, 90, 261, 431))
        ...
        self.AngleFourAddButton.setGeometry(QRect(196, 160, 51, 31))
        ...
        self.AngleSixAddButton.setGeometry(QRect(196, 240, 51, 31))
        ...
        self.AngleFourEdit.setGeometry(QRect(121, 160, 71, 31))
        self.AngleFourEdit.setReadOnly(True)
        self.AngleOneEdit = QLineEdit(self.RobotArmControlGroup)
        self.AngleOneEdit.setObjectName(u"AngleOneEdit")
        self.AngleOneEdit.setGeometry(QRect(121, 40, 71, 31))
        self.AngleOneEdit.setReadOnly(True)
        ...
        self.AngleThreeAddButton.setGeometry(QRect(196, 120, 51, 31))
        self.AngleStepEdit = QLineEdit(self.RobotArmControlGroup)
        self.AngleStepEdit.setObjectName(u"AngleStepEdit")
        self.AngleStepEdit.setGeometry(QRect(121, 280, 71, 31))
        self.ArmDelayTimeEdit = QLineEdit(self.RobotArmControlGroup)
        self.ArmDelayTimeEdit.setObjectName(u"ArmDelayTimeEdit")
        self.ArmDelayTimeEdit.setGeometry(QRect(122, 361, 71, 31))
        self.ArmDelayTimeSubButton = QPushButton(self.RobotArmControlGroup)
        self.ArmDelayTimeSubButton.setObjectName(u"ArmDelayTimeSubButton")
        self.ArmDelayTimeSubButton.setGeometry(QRect(62, 361, 51, 31))
        self.ArmDelayTimeLabel = QLabel(self.RobotArmControlGroup)
        self.ArmDelayTimeLabel.setObjectName(u"ArmDelayTimeLabel")
        self.ArmDelayTimeLabel.setGeometry(QRect(19, 365, 41, 20))
        self.ArmDelayTimeAddButton = QPushButton(self.RobotArmControlGroup)
        self.ArmDelayTimeAddButton.setObjectName(u"ArmDelayTimeAddButton")
        self.ArmDelayTimeAddButton.setGeometry(QRect(197, 361, 51, 31))
        self.RobotArmAttituControlGroup = QGroupBox(Form)
        self.RobotArmAttituControlGroup.setObjectName(u"RobotArmAttituControlGroup")
        self.RobotArmAttituControlGroup.setGeometry(QRect(1274, 321, 251, 201))
        self.RzAxisAddButton = QPushButton(self.RobotArmAttituControlGroup)
        self.RzAxisAddButton.setObjectName(u"RzAxisAddButton")
        self.RzAxisAddButton.setGeometry(QRect(180, 112, 51, 31))
        self.RzAxisEdit = QLineEdit(self.RobotArmAttituControlGroup)
        self.RzAxisEdit.setObjectName(u"RzAxisEdit")
        self.RzAxisEdit.setGeometry(QRect(100, 112, 71, 31))
        ...
        self.RyAxisSubButton.setGeometry(QRect(40, 72, 51, 31))
        self.ApStepSubButton = QPushButton(self.RobotArmAttituControlGroup)
        self.ApStepSubButton.setObjectName(u"ApStepSubButton")
        self.ApStepSubButton.setGeometry(QRect(40, 150, 51, 31))
        self.ApStepLabel = QLabel(self.RobotArmAttituControlGroup)
        self.ApStepLabel.setObjectName(u"ApStepLabel")
        self.ApStepLabel.setGeometry(QRect(8, 156, 31, 20))
        self.ApStepAddButton = QPushButton(self.RobotArmAttituControlGroup)
        self.ApStepAddButton.setObjectName(u"ApStepAddButton")
        self.ApStepAddButton.setGeometry(QRect(180, 150, 51, 31))
        self.ApStepEdit = QLineEdit(self.RobotArmAttituControlGroup)
        self.ApStepEdit.setObjectName(u"ApStepEdit")
        self.ApStepEdit.setGeometry(QRect(100, 150, 71, 31))
    ...
    def retranslateUi(self, Form):
        ...
        self.ActionUpdateRowButton.setText(QCoreApplication.translate("Form", u"\u66f4\u65b0\u884c", None))
        ...
        self.ActionUpdateColButton.setText(QCoreApplication.translate("Form", u"\u66f4\u65b0\u5217", None))
        self.RecordActivateButton.setText(QCoreApplication.translate("Form", u"\u5f55\u5236\u64cd\u4f5c", None))
        self.RecordDeActivateButton.setText(QCoreApplication.translate("Form", u"\u666e\u901a\u64cd\u4f5c", None))
        ...
        self.RobotArmPositionControlGroup.setTitle(QCoreApplication.translate("Form", u"\u672b\u7aef\u5de5\u5177\u5750\u6807", None))
        ...
        self.CoordinateStepLable.setText(QCoreApplication.translate("Form", u"\u6b65\u957f", None))
        self.CoordinateStepEdit.setText(QCoreApplication.translate("Form", u"0", None))
        self.CoordinateAddButton.setText(QCoreApplication.translate("Form", u"+", None))
        self.CoordinateStepSubButton.setText(QCoreApplication.translate("Form", u"-", None))
        ...
        self.ArmDelayTimeEdit.setText(QCoreApplication.translate("Form", u"0", None))
        self.ArmDelayTimeSubButton.setText(QCoreApplication.translate("Form", u"-", None))
        self.ArmDelayTimeLabel.setText(QCoreApplication.translate("Form", u"\u5ef6\u65f6", None))
        self.ArmDelayTimeAddButton.setText(QCoreApplication.translate("Form", u"+", None))
        self.RobotArmAttituControlGroup.setTitle(QCoreApplication.translate("Form", u"\u672b\u7aef\u5de5\u5177\u59ff\u6001", None))
        ...
        self.ApStepSubButton.setText(QCoreApplication.translate("Form", u"-", None))
        self.ApStepLabel.setText(QCoreApplication.translate("Form", u"\u6b65\u957f", None))
        self.ApStepAddButton.setText(QCoreApplication.translate("Form", u"+", None))
