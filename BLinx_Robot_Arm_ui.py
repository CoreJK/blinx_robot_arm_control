...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.CommondPage = QWidget()
        self.CommondPage.setObjectName(u"CommondPage")
        self.SendWindow = QTextEdit(self.CommondPage)
        self.SendWindow.setObjectName(u"SendWindow")
        self.SendWindow.setGeometry(QRect(20, 30, 901, 131))
        self.CommondEditWindow = QTextEdit(self.CommondPage)
        self.CommondEditWindow.setObjectName(u"CommondEditWindow")
        self.CommondEditWindow.setGeometry(QRect(20, 506, 771, 51))
        self.CommndSendButton = QPushButton(self.CommondPage)
        self.CommndSendButton.setObjectName(u"CommndSendButton")
        self.CommndSendButton.setGeometry(QRect(800, 506, 121, 51))
        self.ResponseWindow = QTextEdit(self.CommondPage)
        self.ResponseWindow.setObjectName(u"ResponseWindow")
        self.ResponseWindow.setGeometry(QRect(19, 204, 901, 121))
        self.SendLabel = QLabel(self.CommondPage)
        self.SendLabel.setObjectName(u"SendLabel")
        self.SendLabel.setGeometry(QRect(20, 10, 54, 12))
        self.ResponseLabel = QLabel(self.CommondPage)
        self.ResponseLabel.setObjectName(u"ResponseLabel")
        self.ResponseLabel.setGeometry(QRect(19, 184, 54, 12))
        self.CommondArmRunLogLabel = QLabel(self.CommondPage)
        self.CommondArmRunLogLabel.setObjectName(u"CommondArmRunLogLabel")
        self.CommondArmRunLogLabel.setGeometry(QRect(20, 339, 91, 16))
        self.CommondArmRunLogWindow = QTextBrowser(self.CommondPage)
        self.CommondArmRunLogWindow.setObjectName(u"CommondArmRunLogWindow")
        self.CommondArmRunLogWindow.setGeometry(QRect(19, 365, 901, 131))
        self.HomePage.addTab(self.CommondPage, "")
    ...
    def retranslateUi(self, Form):
        ...
        self.SendWindow.setPlaceholderText(QCoreApplication.translate("Form", u"\u53d1\u9001", None))
        self.CommondEditWindow.setPlaceholderText(QCoreApplication.translate("Form", u"\u8bf7\u8f93\u5165\u7b26\u5408 json \u683c\u5f0f\u7684\u63a7\u5236\u547d\u4ee4", None))
        self.CommndSendButton.setText(QCoreApplication.translate("Form", u"\u53d1\u9001", None))
        self.ResponseWindow.setPlaceholderText(QCoreApplication.translate("Form", u"\u54cd\u5e94", None))
        self.SendLabel.setText(QCoreApplication.translate("Form", u"\u53d1\u9001", None))
        self.ResponseLabel.setText(QCoreApplication.translate("Form", u"\u54cd\u5e94", None))
        self.CommondArmRunLogLabel.setText(QCoreApplication.translate("Form", u"\u673a\u68b0\u81c2\u8fd0\u884c\u65e5\u5fd7", None))
        self.HomePage.setTabText(self.HomePage.indexOf(self.CommondPage), QCoreApplication.translate("Form", u"\u547d\u4ee4\u63a7\u5236", None))
